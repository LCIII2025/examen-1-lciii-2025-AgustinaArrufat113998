...
public class Estacionamiento {
    ...
    public boolean ingresarVehiculo(String dni, String nombre, Vehiculo vehiculo) {
        // LISTO TODO implementar la logica para registrar el ingreso de un nuevo vehiculo en el parking
        ...
        // agregar el nuevo vehiculo en la lista del cliente existente, caso contrario crear un nuevo registro
    ...
    public Ticket retirarVehiculo(String patente) throws Exception {
        // LISTO TODO implementar la lógica para retirar un vehiculo del parking
